...
import { Callout, Image, YouTube } from 'components'; // Example imports for custom components
...
<Callout type="info" title="Quick Fact">
...
<Image src="/images/vehicle-setup.jpg" alt="Overlanding vehicle setup" />
...
<YouTube videoId="dQw4w9WgXcQ" title="Overlanding in Australia" />
